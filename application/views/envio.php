		...
		<div class="row">
			...
			<article class="col-sm-12 maincontent">
				...
				<ul>
					...
					<li>Dúvidas deverão ser encaminhadas pelo endereço de e-mail: seminarioufsm@gmail.com </li>
				</ul>
				
				<h4><b>Orientações para submissão de propostas de oficina:</b></h4>
				<ul>
					<li>As propostas só serão aceitas mediante envio do formulário disponível no site do evento. </li>
					<li>Cada proposta deve ser enviada uma única vez, pelo proponente; os demais responsáveis pela oficina não devem reenviá-la.</li>
					<li>Dúvidas deverão ser encaminhadas ao endereço de e-mail: semanaacademicace@gmail.com </li>
				</ul>
			</article>
